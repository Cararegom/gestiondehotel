...
- Edge Functions: `bank-email-api` v20 (`verify_jwt=true`), `gmail-webhook` v14, `gmail-watch-renew` v9 y `gmail-oauth-callback` v8. Las tres entradas externas sin JWT aplican autenticación específica en código; debe conservarse y probarse.
