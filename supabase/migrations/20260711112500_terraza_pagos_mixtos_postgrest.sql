-- Reparacion idempotente para exponer el cobro mixto de Terraza en PostgREST.
-- Si la migracion original no se ejecuto en remoto, esta vuelve a crear el RPC.
...
GRANT EXECUTE ON FUNCTION public.cerrar_pedido_terraza_mixto(
  uuid,
  uuid,
  uuid,
  jsonb,
